//
//  DS_NewsDetailAdvertTableViewCell.m
//  DSLottery
//
...
@interface DS_NewsDetailAdvertTableViewCell ()
...
@implementation DS_NewsDetailAdvertTableViewCell
...
- (UIImageView *)advertImageView {
    if (!_advertImageView) {
        ...
        _advertImageView.image = PLACEHOLDER_ADVERT;
    }
